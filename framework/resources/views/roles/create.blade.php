      ...
      <div class="card-body">
        ...
        <div class="row" style="height:500px; overflow-y:auto;">  
          <table class="table table-bordered">
            ...
            <tbody>
              @php $new_names = ['users','Reception','tracker','drivers','customers','vehicles','vehicle_type','vehicleGroup','vehicle_inspection','transactions','bookings','booking_quotes','reports','fuel','vendors','parts','parts_category','work_orders','mechanics','notes','serviceReminders','serviceItems','testimonials','team','settings','inquiries','contracts' ]; @endphp
